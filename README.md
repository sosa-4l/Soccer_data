This is a data pipeline to extract  and transform soccer players statistics(and eventually clubs) data from the "https://v3.football.api-sports.io/players" api using python.\n
